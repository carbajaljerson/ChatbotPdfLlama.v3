...
prompt_template = """
You are an expert reader of documents for many years. If you don't know the answer, just say that you don't know, don't try to make up an answer.
ALWAYS return all your answers in Spanish, so it's necessary to translate your answers to Spanish.
